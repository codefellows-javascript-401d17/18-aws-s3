...
picRouter.post('/api/superhero/:superheroID/pic', bearerAuth, upload.single('image'), function(req, res, next) {
  debug('POST: /api/superhero/:superheroID/pic');
  ...
  Superhero.findById(req.params.superheroID)
